...
from karya.core.models import EpicType, Priority, TicketType
...
def cli(ctx: click.Context, show_help: bool, use_json: bool) -> None:
    ...
    if show_help or ctx.invoked_subcommand is None:  # pragma: no cover
        ...
        console.print(Panel("Karya - filesystem-native agent workspace protocol", title="Karya"))
        console.print("\n[bold]The Five Commands That Matter:[/bold]")
        console.print("  karya next        # what should I work on? (Phase B)")
        console.print("  karya context     # what do I need to know? (Phase B)")
        console.print("  karya log         # what did I just do?")
        console.print("  karya done        # I finished this")
        console.print("  karya adr         # I made an architectural decision")
        ctx.exit(0)
